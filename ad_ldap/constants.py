...
CAT_USER = b'CN=Person,CN=Schema,'
CAT_COMPUTER = b'CN=Computer,CN=Schema,'
CAT_GROUP = b'CN=Group,CN=Schema,'
CAT_OU = b'CN=Organizational-Unit,CN=Schema,'
CAT_CN = b'CN=Container,CN=Schema,'
CAT_DOMAIN = b'CN=Domain-DNS,CN=Schema,'

# The set of objectClass values required for each kind of object
CLASS_USER = [b'organizationalPerson', b'person', b'top', b'user']
CLASS_COMPUTER = [b'computer', b'organizationalPerson', b'person', b'top', b'user']
CLASS_OU = [b'organizationalUnit', b'top']
CLASS_GROUP = [b'group', b'top']
